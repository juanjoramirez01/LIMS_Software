...
export default {
    ...
    methods:{
        ...
        actualizarRegistro(){
            let datosEnviar={id:this.$route.params.id , doc:this.paciente.doc , name:this.paciente.name , lastname:this.paciente.lastname , age:this.paciente.age , gender:this.paciente.gender , eps:this.paciente.eps , tp:this.paciente.tp , ptt:this.paciente.ptt , at:this.paciente.at , tt:this.paciente.tt , fib:this.paciente.fib}
